                                          ...
                                          <div style="font-size: 14px; margin: 12px 0px 24px 0px; padding-top: 10px; border-top: 1px solid #aaaaaa;">
                                             ...
                                             <#if contextNodeRef.isContainer>
                                                 <#if contextNodeRef.siteShortName??>
                                                    ${shareUrl}/page/site/${contextNodeRef.siteShortName}/folder-details?nodeRef=${contextNodeRef.nodeRef}
                                                 <#else>
                                                    ${shareUrl}/page/folder-details?nodeRef=${contextNodeRef.nodeRef}
                                                 </#if>
                                             <#else>
                                                 ${contextNodeRef.shareUrl}
                                             </#if></p>
