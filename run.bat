...
:build_share
    ...
    docker-compose -f "%COMPOSE_FILE_PATH%" rm -f alfresco-mention-share
	call %MVN_EXEC% clean package -pl alfresco-mention-share,alfresco-mention-share-docker
EXIT /B 0
:build_acs
    docker-compose -f "%COMPOSE_FILE_PATH%" kill alfresco-mention-acs
    docker-compose -f "%COMPOSE_FILE_PATH%" rm -f alfresco-mention-acs
	call %MVN_EXEC% clean package -pl alfresco-mention-integration-tests,alfresco-mention-repo,alfresco-mention-repo-docker
EXIT /B 0
:tail
...
EXIT /B 0
:prepare-test
    call %MVN_EXEC% verify -DskipTests=true -pl alfresco-mention-repo,alfresco-mention-integration-tests,alfresco-mention-repo-docker
EXIT /B 0
:test
    call %MVN_EXEC% verify -pl alfresco-mention-repo,alfresco-mention-integration-tests
EXIT /B 0
:purge
